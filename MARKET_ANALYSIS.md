# SwiftGST: Market, Competition & Go-to-Market Analysis
...
No direct competitor exists in Bhutan that combines:
- Simple UI (vs. Tally's complexity)
- Affordable pricing (vs. Quickbooks' Nu. 10K+/month)
- GST-native workflows (vs. generic accounting software)
- Service + Retail unified (vs. horizontal players)

Your painkiller is working in a white space market. **Move fast.**

---

## PART 1: BHUTAN MARKET LANDSCAPE

### 1.1 TAM, SAM, SOM Analysis

#### Total Addressable Market (TAM)
**All Bhutanese registered businesses:**

```
Retail/Shops:           3,500 businesses
Construction/Services:  1,500 businesses
Hotels/Restaurants:       500 businesses
Other (transport, etc): 1,000 businesses
─────────────────────────────────────
TOTAL:                  6,500 businesses
```

**TAM = Nu. 390 million/year** (if all subscribed to POS Lite at Nu. 599/month)

#### Serviceable Addressable Market (SAM)
**Businesses with internet access + willingness to adopt digital:**

```
Urban (Thimphu, Punakha, Paro): 60% of TAM = 3,900 businesses
With smartphone/laptop:         80% of urban = 3,120 businesses
Monthly budget > Nu. 300:       40% of those = 1,248 businesses

SAM = 1,248 businesses = Nu. 74.9M/year potential
```
...
```
Conservative: 5% of SAM = 62 businesses = Nu. 4.5M/year
Aggressive:   15% of SAM = 187 businesses = Nu. 13.4M/year

SOM (conservative) = Nu. 4.5M/year (Nu. 375K/month at maturity)
```
